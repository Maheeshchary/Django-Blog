...
from .models import Django, Development, Networking

# For Django posts
class DjangoDeleteView(DeleteView):
    model = Django
    template_name = 'post_confirm_delete.html'
    success_url = reverse_lazy('home')  # Redirect after successful deletion

# For Development posts
class DevelopmentDeleteView(DeleteView):
    model = Development
    template_name = 'post_confirm_delete.html'
    success_url = reverse_lazy('home')  # Redirect after successful deletion

# For Networking posts
...
class DjangoDeleteView(LoginRequiredMixin, DeleteView):
    model = Django
    template_name = 'post_confirm_delete.html'
